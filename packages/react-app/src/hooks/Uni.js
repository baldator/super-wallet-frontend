...
export function swapUniswap() { 
  const provider = new ethers.providers.JsonRpcProvider("https://ropsten.infura.io/v3/f1d09e091182496092bcc798f15cecf0");
  ...
  async function main() {
    ...
    const TokenA = new Token(3, immutables.token0, 6, "fDAIx", "Super fDAI Fake Token");
